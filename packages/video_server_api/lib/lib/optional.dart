...
final class Present<T> extends Optional<T> {
  ...
  @override
  Optional<R> map<R>(R Function(T value) transform) =>
      Optional.present(transform(_value));

  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is Present<T> && _value == other._value);
...
Object? readOptionalValue(Map<dynamic, dynamic> map, String key) {
