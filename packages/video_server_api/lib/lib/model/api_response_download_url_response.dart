...
part 'api_response_download_url_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDownloadUrlResponse
    implements
        Built<ApiResponseDownloadUrlResponse,
  ...
  DownloadUrlResponse get data;

  ApiResponseDownloadUrlResponse._();

  factory ApiResponseDownloadUrlResponse(
          [void updates(ApiResponseDownloadUrlResponseBuilder b)]) =
      _$ApiResponseDownloadUrlResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDownloadUrlResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDownloadUrlResponse> get serializer =>
      _$ApiResponseDownloadUrlResponseSerializer();
}

class _$ApiResponseDownloadUrlResponseSerializer
    implements PrimitiveSerializer<ApiResponseDownloadUrlResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDownloadUrlResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDownloadUrlResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDownloadUrlResponseBuilder result,
  ...
  @override
  ApiResponseDownloadUrlResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDownloadUrlResponseBuilder();
