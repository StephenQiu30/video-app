...
part 'api_response_provider_catalog_entry_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseProviderCatalogEntryResponse
    implements
        Built<ApiResponseProviderCatalogEntryResponse,
  ...
  ProviderCatalogEntryResponse get data;

  ApiResponseProviderCatalogEntryResponse._();

  factory ApiResponseProviderCatalogEntryResponse(
          [void updates(ApiResponseProviderCatalogEntryResponseBuilder b)]) =
      _$ApiResponseProviderCatalogEntryResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseProviderCatalogEntryResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseProviderCatalogEntryResponse> get serializer =>
      _$ApiResponseProviderCatalogEntryResponseSerializer();
}

class _$ApiResponseProviderCatalogEntryResponseSerializer
    implements PrimitiveSerializer<ApiResponseProviderCatalogEntryResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseProviderCatalogEntryResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseProviderCatalogEntryResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseProviderCatalogEntryResponseBuilder result,
  ...
  @override
  ApiResponseProviderCatalogEntryResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseProviderCatalogEntryResponseBuilder();
