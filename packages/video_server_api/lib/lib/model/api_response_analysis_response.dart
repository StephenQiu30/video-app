...
part 'api_response_analysis_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseAnalysisResponse
    implements
        Built<ApiResponseAnalysisResponse, ApiResponseAnalysisResponseBuilder> {
  /// 稳定的业务结果码。
  ...
  ApiResponseAnalysisResponse._();

  factory ApiResponseAnalysisResponse(
          [void updates(ApiResponseAnalysisResponseBuilder b)]) =
      _$ApiResponseAnalysisResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseAnalysisResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseAnalysisResponse> get serializer =>
      _$ApiResponseAnalysisResponseSerializer();
}

class _$ApiResponseAnalysisResponseSerializer
    implements PrimitiveSerializer<ApiResponseAnalysisResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseAnalysisResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseAnalysisResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseAnalysisResponseBuilder result,
  ...
  @override
  ApiResponseAnalysisResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseAnalysisResponseBuilder();
