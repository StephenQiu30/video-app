...
part 'api_response_download_history_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDownloadHistoryResponse
    implements
        Built<ApiResponseDownloadHistoryResponse,
  ...
  DownloadHistoryResponse get data;

  ApiResponseDownloadHistoryResponse._();

  factory ApiResponseDownloadHistoryResponse(
          [void updates(ApiResponseDownloadHistoryResponseBuilder b)]) =
      _$ApiResponseDownloadHistoryResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDownloadHistoryResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDownloadHistoryResponse> get serializer =>
      _$ApiResponseDownloadHistoryResponseSerializer();
}

class _$ApiResponseDownloadHistoryResponseSerializer
    implements PrimitiveSerializer<ApiResponseDownloadHistoryResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDownloadHistoryResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDownloadHistoryResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDownloadHistoryResponseBuilder result,
  ...
  @override
  ApiResponseDownloadHistoryResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDownloadHistoryResponseBuilder();
