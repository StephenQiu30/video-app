...
part 'api_response_provider_runtime_list_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseProviderRuntimeListResponse
    implements
        Built<ApiResponseProviderRuntimeListResponse,
  ...
  ProviderRuntimeListResponse get data;

  ApiResponseProviderRuntimeListResponse._();

  factory ApiResponseProviderRuntimeListResponse(
          [void updates(ApiResponseProviderRuntimeListResponseBuilder b)]) =
      _$ApiResponseProviderRuntimeListResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseProviderRuntimeListResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseProviderRuntimeListResponse> get serializer =>
      _$ApiResponseProviderRuntimeListResponseSerializer();
}

class _$ApiResponseProviderRuntimeListResponseSerializer
    implements PrimitiveSerializer<ApiResponseProviderRuntimeListResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseProviderRuntimeListResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseProviderRuntimeListResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseProviderRuntimeListResponseBuilder result,
  ...
  @override
  ApiResponseProviderRuntimeListResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseProviderRuntimeListResponseBuilder();
