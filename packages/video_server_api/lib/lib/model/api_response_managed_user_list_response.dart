...
part 'api_response_managed_user_list_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseManagedUserListResponse
    implements
        Built<ApiResponseManagedUserListResponse,
  ...
  ManagedUserListResponse get data;

  ApiResponseManagedUserListResponse._();

  factory ApiResponseManagedUserListResponse(
          [void updates(ApiResponseManagedUserListResponseBuilder b)]) =
      _$ApiResponseManagedUserListResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseManagedUserListResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseManagedUserListResponse> get serializer =>
      _$ApiResponseManagedUserListResponseSerializer();
}

class _$ApiResponseManagedUserListResponseSerializer
    implements PrimitiveSerializer<ApiResponseManagedUserListResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseManagedUserListResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseManagedUserListResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseManagedUserListResponseBuilder result,
  ...
  @override
  ApiResponseManagedUserListResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseManagedUserListResponseBuilder();
