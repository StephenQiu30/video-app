...
part 'api_response_union_analysis_response_none_type.g.dart';
...
abstract class ApiResponseUnionAnalysisResponseNoneType
  ...
  AnalysisResponse? get data;

  ApiResponseUnionAnalysisResponseNoneType._();

  factory ApiResponseUnionAnalysisResponseNoneType(
          [void updates(ApiResponseUnionAnalysisResponseNoneTypeBuilder b)]) =
      _$ApiResponseUnionAnalysisResponseNoneType;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseUnionAnalysisResponseNoneTypeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseUnionAnalysisResponseNoneType> get serializer =>
      _$ApiResponseUnionAnalysisResponseNoneTypeSerializer();
}

class _$ApiResponseUnionAnalysisResponseNoneTypeSerializer
    implements PrimitiveSerializer<ApiResponseUnionAnalysisResponseNoneType> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseUnionAnalysisResponseNoneType';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseUnionAnalysisResponseNoneType object, {
    ...
    yield object.data == null
        ...
        : serializers.serialize(
            object.data,
            specifiedType: const FullType.nullable(AnalysisResponse),
          );
  }
  ...
  void _deserializeProperties(
    ...
    required ApiResponseUnionAnalysisResponseNoneTypeBuilder result,
  ...
  @override
  ApiResponseUnionAnalysisResponseNoneType deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseUnionAnalysisResponseNoneTypeBuilder();
