...
part 'api_response_inspection_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseInspectionResponse
    implements
        Built<ApiResponseInspectionResponse,
  ...
  InspectionResponse get data;

  ApiResponseInspectionResponse._();

  factory ApiResponseInspectionResponse(
          [void updates(ApiResponseInspectionResponseBuilder b)]) =
      _$ApiResponseInspectionResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseInspectionResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseInspectionResponse> get serializer =>
      _$ApiResponseInspectionResponseSerializer();
}

class _$ApiResponseInspectionResponseSerializer
    implements PrimitiveSerializer<ApiResponseInspectionResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseInspectionResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseInspectionResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseInspectionResponseBuilder result,
  ...
  @override
  ApiResponseInspectionResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseInspectionResponseBuilder();
