...
part 'api_response_storage_cleanup_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseStorageCleanupResponse
    implements
        Built<ApiResponseStorageCleanupResponse,
  ...
  StorageCleanupResponse get data;

  ApiResponseStorageCleanupResponse._();

  factory ApiResponseStorageCleanupResponse(
          [void updates(ApiResponseStorageCleanupResponseBuilder b)]) =
      _$ApiResponseStorageCleanupResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseStorageCleanupResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseStorageCleanupResponse> get serializer =>
      _$ApiResponseStorageCleanupResponseSerializer();
}

class _$ApiResponseStorageCleanupResponseSerializer
    implements PrimitiveSerializer<ApiResponseStorageCleanupResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseStorageCleanupResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseStorageCleanupResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseStorageCleanupResponseBuilder result,
  ...
  @override
  ApiResponseStorageCleanupResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseStorageCleanupResponseBuilder();
