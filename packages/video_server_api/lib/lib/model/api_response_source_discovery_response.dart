...
part 'api_response_source_discovery_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseSourceDiscoveryResponse
    implements
        Built<ApiResponseSourceDiscoveryResponse,
  ...
  SourceDiscoveryResponse get data;

  ApiResponseSourceDiscoveryResponse._();

  factory ApiResponseSourceDiscoveryResponse(
          [void updates(ApiResponseSourceDiscoveryResponseBuilder b)]) =
      _$ApiResponseSourceDiscoveryResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseSourceDiscoveryResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseSourceDiscoveryResponse> get serializer =>
      _$ApiResponseSourceDiscoveryResponseSerializer();
}

class _$ApiResponseSourceDiscoveryResponseSerializer
    implements PrimitiveSerializer<ApiResponseSourceDiscoveryResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseSourceDiscoveryResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseSourceDiscoveryResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseSourceDiscoveryResponseBuilder result,
  ...
  @override
  ApiResponseSourceDiscoveryResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseSourceDiscoveryResponseBuilder();
