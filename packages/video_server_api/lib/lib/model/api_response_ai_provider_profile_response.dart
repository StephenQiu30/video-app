...
part 'api_response_ai_provider_profile_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseAiProviderProfileResponse
    implements
        Built<ApiResponseAiProviderProfileResponse,
  ...
  AiProviderProfileResponse get data;

  ApiResponseAiProviderProfileResponse._();

  factory ApiResponseAiProviderProfileResponse(
          [void updates(ApiResponseAiProviderProfileResponseBuilder b)]) =
      _$ApiResponseAiProviderProfileResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseAiProviderProfileResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseAiProviderProfileResponse> get serializer =>
      _$ApiResponseAiProviderProfileResponseSerializer();
}

class _$ApiResponseAiProviderProfileResponseSerializer
    implements PrimitiveSerializer<ApiResponseAiProviderProfileResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseAiProviderProfileResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseAiProviderProfileResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseAiProviderProfileResponseBuilder result,
  ...
  @override
  ApiResponseAiProviderProfileResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseAiProviderProfileResponseBuilder();
