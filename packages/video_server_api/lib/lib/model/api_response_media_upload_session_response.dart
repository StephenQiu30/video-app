...
part 'api_response_media_upload_session_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseMediaUploadSessionResponse
    implements
        Built<ApiResponseMediaUploadSessionResponse,
  ...
  MediaUploadSessionResponse get data;

  ApiResponseMediaUploadSessionResponse._();

  factory ApiResponseMediaUploadSessionResponse(
          [void updates(ApiResponseMediaUploadSessionResponseBuilder b)]) =
      _$ApiResponseMediaUploadSessionResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseMediaUploadSessionResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseMediaUploadSessionResponse> get serializer =>
      _$ApiResponseMediaUploadSessionResponseSerializer();
}

class _$ApiResponseMediaUploadSessionResponseSerializer
    implements PrimitiveSerializer<ApiResponseMediaUploadSessionResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseMediaUploadSessionResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseMediaUploadSessionResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseMediaUploadSessionResponseBuilder result,
  ...
  @override
  ApiResponseMediaUploadSessionResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseMediaUploadSessionResponseBuilder();
