...
part 'api_response_tuple_analysis_skill_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseTupleAnalysisSkillResponse
    implements
        Built<ApiResponseTupleAnalysisSkillResponse,
  ...
  BuiltList<AnalysisSkillResponse> get data;

  ApiResponseTupleAnalysisSkillResponse._();

  factory ApiResponseTupleAnalysisSkillResponse(
          [void updates(ApiResponseTupleAnalysisSkillResponseBuilder b)]) =
      _$ApiResponseTupleAnalysisSkillResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseTupleAnalysisSkillResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseTupleAnalysisSkillResponse> get serializer =>
      _$ApiResponseTupleAnalysisSkillResponseSerializer();
}

class _$ApiResponseTupleAnalysisSkillResponseSerializer
    implements PrimitiveSerializer<ApiResponseTupleAnalysisSkillResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseTupleAnalysisSkillResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseTupleAnalysisSkillResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseTupleAnalysisSkillResponseBuilder result,
  ...
  @override
  ApiResponseTupleAnalysisSkillResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseTupleAnalysisSkillResponseBuilder();
