...
part 'api_response_document_upload_session_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDocumentUploadSessionResponse
    implements
        Built<ApiResponseDocumentUploadSessionResponse,
  ...
  DocumentUploadSessionResponse get data;

  ApiResponseDocumentUploadSessionResponse._();

  factory ApiResponseDocumentUploadSessionResponse(
          [void updates(ApiResponseDocumentUploadSessionResponseBuilder b)]) =
      _$ApiResponseDocumentUploadSessionResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDocumentUploadSessionResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDocumentUploadSessionResponse> get serializer =>
      _$ApiResponseDocumentUploadSessionResponseSerializer();
}

class _$ApiResponseDocumentUploadSessionResponseSerializer
    implements PrimitiveSerializer<ApiResponseDocumentUploadSessionResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDocumentUploadSessionResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDocumentUploadSessionResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDocumentUploadSessionResponseBuilder result,
  ...
  @override
  ApiResponseDocumentUploadSessionResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDocumentUploadSessionResponseBuilder();
