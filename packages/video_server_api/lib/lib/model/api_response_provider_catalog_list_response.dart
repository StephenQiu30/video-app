...
part 'api_response_provider_catalog_list_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseProviderCatalogListResponse
    implements
        Built<ApiResponseProviderCatalogListResponse,
  ...
  ProviderCatalogListResponse get data;

  ApiResponseProviderCatalogListResponse._();

  factory ApiResponseProviderCatalogListResponse(
          [void updates(ApiResponseProviderCatalogListResponseBuilder b)]) =
      _$ApiResponseProviderCatalogListResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseProviderCatalogListResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseProviderCatalogListResponse> get serializer =>
      _$ApiResponseProviderCatalogListResponseSerializer();
}

class _$ApiResponseProviderCatalogListResponseSerializer
    implements PrimitiveSerializer<ApiResponseProviderCatalogListResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseProviderCatalogListResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseProviderCatalogListResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseProviderCatalogListResponseBuilder result,
  ...
  @override
  ApiResponseProviderCatalogListResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseProviderCatalogListResponseBuilder();
