...
part 'api_response_stored_file_list_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseStoredFileListResponse
    implements
        Built<ApiResponseStoredFileListResponse,
  ...
  StoredFileListResponse get data;

  ApiResponseStoredFileListResponse._();

  factory ApiResponseStoredFileListResponse(
          [void updates(ApiResponseStoredFileListResponseBuilder b)]) =
      _$ApiResponseStoredFileListResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseStoredFileListResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseStoredFileListResponse> get serializer =>
      _$ApiResponseStoredFileListResponseSerializer();
}

class _$ApiResponseStoredFileListResponseSerializer
    implements PrimitiveSerializer<ApiResponseStoredFileListResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseStoredFileListResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseStoredFileListResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseStoredFileListResponseBuilder result,
  ...
  @override
  ApiResponseStoredFileListResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseStoredFileListResponseBuilder();
