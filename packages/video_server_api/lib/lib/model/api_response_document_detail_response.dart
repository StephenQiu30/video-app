...
part 'api_response_document_detail_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDocumentDetailResponse
    implements
        Built<ApiResponseDocumentDetailResponse,
  ...
  DocumentDetailResponse get data;

  ApiResponseDocumentDetailResponse._();

  factory ApiResponseDocumentDetailResponse(
          [void updates(ApiResponseDocumentDetailResponseBuilder b)]) =
      _$ApiResponseDocumentDetailResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDocumentDetailResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDocumentDetailResponse> get serializer =>
      _$ApiResponseDocumentDetailResponseSerializer();
}

class _$ApiResponseDocumentDetailResponseSerializer
    implements PrimitiveSerializer<ApiResponseDocumentDetailResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDocumentDetailResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDocumentDetailResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDocumentDetailResponseBuilder result,
  ...
  @override
  ApiResponseDocumentDetailResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDocumentDetailResponseBuilder();
