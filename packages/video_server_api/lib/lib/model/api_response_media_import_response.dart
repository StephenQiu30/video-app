...
part 'api_response_media_import_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseMediaImportResponse
    implements
        Built<ApiResponseMediaImportResponse,
  ...
  MediaImportResponse get data;

  ApiResponseMediaImportResponse._();

  factory ApiResponseMediaImportResponse(
          [void updates(ApiResponseMediaImportResponseBuilder b)]) =
      _$ApiResponseMediaImportResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseMediaImportResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseMediaImportResponse> get serializer =>
      _$ApiResponseMediaImportResponseSerializer();
}

class _$ApiResponseMediaImportResponseSerializer
    implements PrimitiveSerializer<ApiResponseMediaImportResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseMediaImportResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseMediaImportResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseMediaImportResponseBuilder result,
  ...
  @override
  ApiResponseMediaImportResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseMediaImportResponseBuilder();
