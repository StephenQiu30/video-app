...
part 'api_response_intent_history_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseIntentHistoryResponse
    implements
        Built<ApiResponseIntentHistoryResponse,
  ...
  IntentHistoryResponse get data;

  ApiResponseIntentHistoryResponse._();

  factory ApiResponseIntentHistoryResponse(
          [void updates(ApiResponseIntentHistoryResponseBuilder b)]) =
      _$ApiResponseIntentHistoryResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseIntentHistoryResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseIntentHistoryResponse> get serializer =>
      _$ApiResponseIntentHistoryResponseSerializer();
}

class _$ApiResponseIntentHistoryResponseSerializer
    implements PrimitiveSerializer<ApiResponseIntentHistoryResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseIntentHistoryResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseIntentHistoryResponse object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(IntentHistoryResponse),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required ApiResponseIntentHistoryResponseBuilder result,
  ...
  @override
  ApiResponseIntentHistoryResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseIntentHistoryResponseBuilder();
