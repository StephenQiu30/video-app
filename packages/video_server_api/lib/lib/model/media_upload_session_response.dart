...
part 'media_upload_session_response.g.dart';
...
/// * [parts]
@BuiltValue()
abstract class MediaUploadSessionResponse
    implements
        Built<MediaUploadSessionResponse, MediaUploadSessionResponseBuilder> {
  ...
  MediaUploadSessionResponse._();

  factory MediaUploadSessionResponse(
          [void updates(MediaUploadSessionResponseBuilder b)]) =
      _$MediaUploadSessionResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MediaUploadSessionResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MediaUploadSessionResponse> get serializer =>
      _$MediaUploadSessionResponseSerializer();
}

class _$MediaUploadSessionResponseSerializer
    implements PrimitiveSerializer<MediaUploadSessionResponse> {
  @override
  ...
  @override
  final String wireName = r'MediaUploadSessionResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MediaUploadSessionResponse object, {
  ...
  void _deserializeProperties(
    ...
    required MediaUploadSessionResponseBuilder result,
  ...
  @override
  MediaUploadSessionResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MediaUploadSessionResponseBuilder();
