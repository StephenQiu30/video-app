...
part 'api_response_document_page_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDocumentPageResponse
    implements
        Built<ApiResponseDocumentPageResponse,
  ...
  DocumentPageResponse get data;

  ApiResponseDocumentPageResponse._();

  factory ApiResponseDocumentPageResponse(
          [void updates(ApiResponseDocumentPageResponseBuilder b)]) =
      _$ApiResponseDocumentPageResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDocumentPageResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDocumentPageResponse> get serializer =>
      _$ApiResponseDocumentPageResponseSerializer();
}

class _$ApiResponseDocumentPageResponseSerializer
    implements PrimitiveSerializer<ApiResponseDocumentPageResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDocumentPageResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDocumentPageResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDocumentPageResponseBuilder result,
  ...
  @override
  ApiResponseDocumentPageResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDocumentPageResponseBuilder();
