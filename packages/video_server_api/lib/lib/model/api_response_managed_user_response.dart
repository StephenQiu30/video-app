...
part 'api_response_managed_user_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseManagedUserResponse
    implements
        Built<ApiResponseManagedUserResponse,
  ...
  ManagedUserResponse get data;

  ApiResponseManagedUserResponse._();

  factory ApiResponseManagedUserResponse(
          [void updates(ApiResponseManagedUserResponseBuilder b)]) =
      _$ApiResponseManagedUserResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseManagedUserResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseManagedUserResponse> get serializer =>
      _$ApiResponseManagedUserResponseSerializer();
}

class _$ApiResponseManagedUserResponseSerializer
    implements PrimitiveSerializer<ApiResponseManagedUserResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseManagedUserResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseManagedUserResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseManagedUserResponseBuilder result,
  ...
  @override
  ApiResponseManagedUserResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseManagedUserResponseBuilder();
