...
part 'api_response_document_import_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDocumentImportResponse
    implements
        Built<ApiResponseDocumentImportResponse,
  ...
  DocumentImportResponse get data;

  ApiResponseDocumentImportResponse._();

  factory ApiResponseDocumentImportResponse(
          [void updates(ApiResponseDocumentImportResponseBuilder b)]) =
      _$ApiResponseDocumentImportResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDocumentImportResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDocumentImportResponse> get serializer =>
      _$ApiResponseDocumentImportResponseSerializer();
}

class _$ApiResponseDocumentImportResponseSerializer
    implements PrimitiveSerializer<ApiResponseDocumentImportResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDocumentImportResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDocumentImportResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDocumentImportResponseBuilder result,
  ...
  @override
  ApiResponseDocumentImportResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDocumentImportResponseBuilder();
