...
part 'api_response_download_analytics_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDownloadAnalyticsResponse
    implements
        Built<ApiResponseDownloadAnalyticsResponse,
  ...
  DownloadAnalyticsResponse get data;

  ApiResponseDownloadAnalyticsResponse._();

  factory ApiResponseDownloadAnalyticsResponse(
          [void updates(ApiResponseDownloadAnalyticsResponseBuilder b)]) =
      _$ApiResponseDownloadAnalyticsResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDownloadAnalyticsResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDownloadAnalyticsResponse> get serializer =>
      _$ApiResponseDownloadAnalyticsResponseSerializer();
}

class _$ApiResponseDownloadAnalyticsResponseSerializer
    implements PrimitiveSerializer<ApiResponseDownloadAnalyticsResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDownloadAnalyticsResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDownloadAnalyticsResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDownloadAnalyticsResponseBuilder result,
  ...
  @override
  ApiResponseDownloadAnalyticsResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDownloadAnalyticsResponseBuilder();
