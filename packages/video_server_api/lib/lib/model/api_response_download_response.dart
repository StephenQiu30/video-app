...
part 'api_response_download_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseDownloadResponse
    implements
        Built<ApiResponseDownloadResponse, ApiResponseDownloadResponseBuilder> {
  /// 稳定的业务结果码。
  ...
  DownloadResponse get data;

  ApiResponseDownloadResponse._();

  factory ApiResponseDownloadResponse(
          [void updates(ApiResponseDownloadResponseBuilder b)]) =
      _$ApiResponseDownloadResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseDownloadResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseDownloadResponse> get serializer =>
      _$ApiResponseDownloadResponseSerializer();
}

class _$ApiResponseDownloadResponseSerializer
    implements PrimitiveSerializer<ApiResponseDownloadResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseDownloadResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseDownloadResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseDownloadResponseBuilder result,
  ...
  @override
  ApiResponseDownloadResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseDownloadResponseBuilder();
