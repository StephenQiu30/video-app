...
part of 'download_error_code.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const DownloadErrorCode _$cancelled = const DownloadErrorCode._('cancelled');
...
const DownloadErrorCode _$tempSpaceExhausted =
    const DownloadErrorCode._('tempSpaceExhausted');
const DownloadErrorCode _$transcodeRequired =
    const DownloadErrorCode._('transcodeRequired');
const DownloadErrorCode _$unsupportedSource =
    const DownloadErrorCode._('unsupportedSource');
const DownloadErrorCode _$workerLost = const DownloadErrorCode._('workerLost');
const DownloadErrorCode _$unknownDefaultOpenApi =
    const DownloadErrorCode._('unknownDefaultOpenApi');

DownloadErrorCode _$valueOf(String name) {
  switch (name) {
    case 'cancelled':
      return _$cancelled;
    ...
    case 'tempSpaceExhausted':
      return _$tempSpaceExhausted;
    case 'transcodeRequired':
      return _$transcodeRequired;
    case 'unsupportedSource':
      return _$unsupportedSource;
    case 'workerLost':
      return _$workerLost;
...
final BuiltSet<DownloadErrorCode> _$values =
    BuiltSet<DownloadErrorCode>(const <DownloadErrorCode>[
  _$cancelled,
  _$downloadTimeout,
  _$formatUnavailable,
  _$inspectionTimeout,
...
class _$DownloadErrorCodeMeta {
  const _$DownloadErrorCodeMeta();
  ...
  DownloadErrorCode get unsupportedSource => _$unsupportedSource;
  DownloadErrorCode get workerLost => _$workerLost;
  DownloadErrorCode get unknownDefaultOpenApi => _$unknownDefaultOpenApi;
  DownloadErrorCode valueOf(String name) => _$valueOf(name);
  BuiltSet<DownloadErrorCode> get values => _$values;
}

mixin _$DownloadErrorCodeMixin {
  // ignore: non_constant_identifier_names
  _$DownloadErrorCodeMeta get DownloadErrorCode =>
      const _$DownloadErrorCodeMeta();
}

Serializer<DownloadErrorCode> _$downloadErrorCodeSerializer =
    _$DownloadErrorCodeSerializer();

class _$DownloadErrorCodeSerializer
    implements PrimitiveSerializer<DownloadErrorCode> {
  ...
  @override
  final Iterable<Type> types = const <Type>[DownloadErrorCode];
  @override
  final String wireName = 'DownloadErrorCode';

  @override
  Object serialize(Serializers serializers, DownloadErrorCode object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  DownloadErrorCode deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      DownloadErrorCode.valueOf(
