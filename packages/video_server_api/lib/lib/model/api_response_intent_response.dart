...
part 'api_response_intent_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseIntentResponse
    implements
        Built<ApiResponseIntentResponse, ApiResponseIntentResponseBuilder> {
  /// 稳定的业务结果码。
  ...
  IntentResponse get data;

  ApiResponseIntentResponse._();

  factory ApiResponseIntentResponse(
          [void updates(ApiResponseIntentResponseBuilder b)]) =
      _$ApiResponseIntentResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseIntentResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseIntentResponse> get serializer =>
      _$ApiResponseIntentResponseSerializer();
}

class _$ApiResponseIntentResponseSerializer
    implements PrimitiveSerializer<ApiResponseIntentResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseIntentResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseIntentResponse object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(IntentResponse),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required ApiResponseIntentResponseBuilder result,
  ...
  @override
  ApiResponseIntentResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseIntentResponseBuilder();
