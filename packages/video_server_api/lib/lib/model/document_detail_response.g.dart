...
part of 'document_detail_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DocumentDetailResponse extends DocumentDetailResponse {
  @override
  final String id;
  @override
  final String title;
  ...
  @override
  final DocumentParseSummaryResponse? parseSummary;

  factory _$DocumentDetailResponse(
          [void Function(DocumentDetailResponseBuilder)? updates]) =>
      (DocumentDetailResponseBuilder()..update(updates))._build();

  _$DocumentDetailResponse._(
      {required this.id,
      required this.title,
      ...
      : super._();
  @override
  DocumentDetailResponse rebuild(
          void Function(DocumentDetailResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DocumentDetailResponseBuilder toBuilder() =>
      DocumentDetailResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DocumentDetailResponse &&
        id == other.id &&
        title == other.title &&
        ...
        parseSummary == other.parseSummary;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, previewTruncated.hashCode);
    _$hash = $jc(_$hash, parseSummary.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DocumentDetailResponse')
          ..add('id', id)
          ..add('title', title)
          ...
          ..add('preview', preview)
          ..add('previewTruncated', previewTruncated)
          ..add('parseSummary', parseSummary))
        .toString();
  }
}

class DocumentDetailResponseBuilder
    implements Builder<DocumentDetailResponse, DocumentDetailResponseBuilder> {
  _$DocumentDetailResponse? _$v;
  ...
  bool? _previewTruncated;
  bool? get previewTruncated => _$this._previewTruncated;
  set previewTruncated(bool? previewTruncated) =>
      _$this._previewTruncated = previewTruncated;

  DocumentParseSummaryResponseBuilder? _parseSummary;
  DocumentParseSummaryResponseBuilder get parseSummary =>
      _$this._parseSummary ??= DocumentParseSummaryResponseBuilder();
  set parseSummary(DocumentParseSummaryResponseBuilder? parseSummary) =>
      _$this._parseSummary = parseSummary;

  DocumentDetailResponseBuilder() {
    DocumentDetailResponse._defaults(this);
  }

  DocumentDetailResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _title = $v.title;
      ...
      _preview = $v.preview;
      _previewTruncated = $v.previewTruncated;
      _parseSummary = $v.parseSummary?.toBuilder();
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(DocumentDetailResponse other) {
    _$v = other as _$DocumentDetailResponse;
  }

  @override
  void update(void Function(DocumentDetailResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DocumentDetailResponse build() => _build();

  _$DocumentDetailResponse _build() {
    _$DocumentDetailResponse _$result;
    try {
      _$result = _$v ??
          _$DocumentDetailResponse._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'DocumentDetailResponse', 'id'),
            title: BuiltValueNullFieldError.checkNotNull(
                title, r'DocumentDetailResponse', 'title'),
            originalFilename: BuiltValueNullFieldError.checkNotNull(
                originalFilename,
                r'DocumentDetailResponse',
                'originalFilename'),
            sourceFormat: BuiltValueNullFieldError.checkNotNull(
                sourceFormat, r'DocumentDetailResponse', 'sourceFormat'),
            declaredSizeBytes: BuiltValueNullFieldError.checkNotNull(
                declaredSizeBytes,
                r'DocumentDetailResponse',
                'declaredSizeBytes'),
            status: BuiltValueNullFieldError.checkNotNull(
                status, r'DocumentDetailResponse', 'status'),
            attempt: BuiltValueNullFieldError.checkNotNull(
                attempt, r'DocumentDetailResponse', 'attempt'),
            errorCode: errorCode,
            version: BuiltValueNullFieldError.checkNotNull(
                version, r'DocumentDetailResponse', 'version'),
            detectedLanguage: detectedLanguage,
            sceneCount: sceneCount,
            characterCount: characterCount,
            qualityWarnings: qualityWarnings.build(),
            createdAt: BuiltValueNullFieldError.checkNotNull(
                createdAt, r'DocumentDetailResponse', 'createdAt'),
            updatedAt: BuiltValueNullFieldError.checkNotNull(
                updatedAt, r'DocumentDetailResponse', 'updatedAt'),
            finishedAt: finishedAt,
            preview: preview,
            previewTruncated: BuiltValueNullFieldError.checkNotNull(
                previewTruncated,
                r'DocumentDetailResponse',
                'previewTruncated'),
            parseSummary: _parseSummary?.build(),
          );
    } catch (_) {
      ...
      try {
        ...
        _$failedField = 'parseSummary';
        _parseSummary?.build();
      } catch (e) {
        throw BuiltValueNestedFieldError(
            r'DocumentDetailResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
