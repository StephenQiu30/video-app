...
part 'api_response_ai_provider_profile_list_response.g.dart';
...
@BuiltValue()
abstract class ApiResponseAiProviderProfileListResponse
    implements
        Built<ApiResponseAiProviderProfileListResponse,
  ...
  AiProviderProfileListResponse get data;

  ApiResponseAiProviderProfileListResponse._();

  factory ApiResponseAiProviderProfileListResponse(
          [void updates(ApiResponseAiProviderProfileListResponseBuilder b)]) =
      _$ApiResponseAiProviderProfileListResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseAiProviderProfileListResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseAiProviderProfileListResponse> get serializer =>
      _$ApiResponseAiProviderProfileListResponseSerializer();
}

class _$ApiResponseAiProviderProfileListResponseSerializer
    implements PrimitiveSerializer<ApiResponseAiProviderProfileListResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseAiProviderProfileListResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseAiProviderProfileListResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseAiProviderProfileListResponseBuilder result,
  ...
  @override
  ApiResponseAiProviderProfileListResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseAiProviderProfileListResponseBuilder();
