...
@BuiltValue()
abstract class ApiResponseUserResponse
    implements Built<ApiResponseUserResponse, ApiResponseUserResponseBuilder> {
  /// 稳定的业务结果码。
  ...
  ApiResponseUserResponse._();

  factory ApiResponseUserResponse(
          [void updates(ApiResponseUserResponseBuilder b)]) =
      _$ApiResponseUserResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiResponseUserResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiResponseUserResponse> get serializer =>
      _$ApiResponseUserResponseSerializer();
}

class _$ApiResponseUserResponseSerializer
    implements PrimitiveSerializer<ApiResponseUserResponse> {
  @override
  ...
  @override
  final String wireName = r'ApiResponseUserResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApiResponseUserResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ApiResponseUserResponseBuilder result,
  ...
  @override
  ApiResponseUserResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiResponseUserResponseBuilder();
