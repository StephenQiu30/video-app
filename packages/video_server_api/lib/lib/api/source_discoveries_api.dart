...
class SourceDiscoveriesApi {
  ...
  const SourceDiscoveriesApi(this._dio, this._serializers);
  ...
  Future<Response<ApiResponseSourceDiscoveryResponse>> createSourceDiscovery({
    ...
    final _path = r'/api/source-discoveries';
    ...
    try {
      const _type = FullType(SourceDiscoveryRequest);
      _bodyData =
          _serializers.serialize(sourceDiscoveryRequest, specifiedType: _type);
  ...
  Future<Response<ApiResponseSourceDiscoveryResponse>> getSourceDiscovery({
    ...
    final _path = r'/api/source-discoveries/{discovery_id}'.replaceAll(
        '{' r'discovery_id' '}',
        encodeQueryParameter(_serializers, discoveryId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
