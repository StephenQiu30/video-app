...
class MediaImportsApi {
  ...
  const MediaImportsApi(this._dio, this._serializers);
  ...
  Future<Response<MediaImportResponse>> completeMediaImport({
    ...
    final _path = r'/api/media-imports/{resource_id}/complete'.replaceAll(
        '{' r'resource_id' '}',
        encodeQueryParameter(_serializers, resourceId, const FullType(String))
            .toString());
    ...
    try {
      const _type = FullType(CompleteMediaImportRequest);
      _bodyData = _serializers.serialize(completeMediaImportRequest,
          specifiedType: _type);
  ...
  Future<Response<MediaImportResponse>> createMediaImport({
    ...
    final _path = r'/api/media-imports';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      const _type = FullType(MediaImportRequest);
      _bodyData =
          _serializers.serialize(mediaImportRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<MediaUploadSessionResponse>> createMediaUploadSession({
    ...
    final _path = r'/api/media-imports/{resource_id}/upload-sessions'
        .replaceAll(
            '{' r'resource_id' '}',
            encodeQueryParameter(
                    _serializers, resourceId, const FullType(String))
                .toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
