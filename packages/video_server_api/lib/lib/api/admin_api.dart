...
class AdminApi {
  ...
  Future<Response<ApiResponseAiProviderProfileResponse>>
    ...
    final _path = r'/api/admin/ai-providers/{provider_key}/activate'.replaceAll(
        '{' r'provider_key' '}',
        encodeQueryParameter(_serializers, providerKey, const FullType(String))
            .toString());
  ...
  Future<Response<ApiResponseStorageCleanupResponse>> cleanupStoredFiles({
    ...
    final _path = r'/api/admin/files/cleanup';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(StorageCleanupRequest);
      _bodyData =
          _serializers.serialize(storageCleanupRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<ApiResponseAiProviderProfileResponse>>
    ...
    final _path = r'/api/admin/ai-providers';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateAiProviderProfileRequest);
      _bodyData = _serializers.serialize(createAiProviderProfileRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<ApiResponseProviderCatalogEntryResponse>>
    ...
    final _path = r'/api/admin/providers';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateProviderCatalogEntryRequest);
      _bodyData = _serializers.serialize(createProviderCatalogEntryRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteAiProviderProfile({
    required String providerKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/admin/ai-providers/{provider_key}'.replaceAll(
        '{' r'provider_key' '}',
        encodeQueryParameter(_serializers, providerKey, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteProviderCatalogEntry({
    required String providerKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/admin/providers/{provider_key}'.replaceAll(
        '{' r'provider_key' '}',
        encodeQueryParameter(_serializers, providerKey, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<ApiResponseDownloadAnalyticsResponse>> getDownloadAnalytics({
    ...
    final _path = r'/api/admin/downloads/analytics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ApiResponseManagedUserListResponse>> listUsers({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (role != null)
        r'role':
            encodeQueryParameter(_serializers, role, const FullType(UserRole)),
      if (isActive != null)
        r'is_active':
  ...
  Future<Response<ApiResponseAiProviderProfileResponse>>
    ...
    try {
      const _type = FullType(UpdateAiProviderProfileRequest);
      _bodyData = _serializers.serialize(updateAiProviderProfileRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<ApiResponseProviderCatalogEntryResponse>>
    ...
    try {
      const _type = FullType(UpdateProviderCatalogEntryRequest);
      _bodyData = _serializers.serialize(updateProviderCatalogEntryRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<ApiResponseManagedUserResponse>> updateUserAccess({
    ...
    final _path = r'/api/admin/users/{user_id}'.replaceAll(
        '{' r'user_id' '}',
    ...
    try {
      const _type = FullType(UpdateUserAccessRequest);
      _bodyData =
          _serializers.serialize(updateUserAccessRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
