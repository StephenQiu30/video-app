...
class DownloadsApi {
  ...
  Future<Response<DownloadResponse>> cancelDownload({
    ...
    final _path = r'/api/downloads/{job_id}/cancel'.replaceAll(
        '{' r'job_id' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteDownload({
    required String jobId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/downloads/{job_id}'.replaceAll(
        '{' r'job_id' '}',
        encodeQueryParameter(_serializers, jobId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<DownloadHistoryResponse>> getDownloadHistory({
    ...
    final _path = r'/api/downloads/history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> getDownloadThumbnail({
    required String jobId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/downloads/{job_id}/thumbnail'.replaceAll(
        '{' r'job_id' '}',
        encodeQueryParameter(_serializers, jobId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<DownloadUrlResponse>> issueDownloadUrl({
    ...
    final _path = r'/api/downloads/{job_id}/download-url'.replaceAll(
        '{' r'job_id' '}',
        encodeQueryParameter(_serializers, jobId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<DownloadResponse>> retryDownload({
    ...
    final _path = r'/api/downloads/{job_id}/retry'.replaceAll(
        '{' r'job_id' '}',
        encodeQueryParameter(_serializers, jobId, const FullType(String))
            .toString());
    final _options = Options(
