...
class DocumentsApi {
  ...
  Future<Response<DocumentImportResponse>> cancelDocumentImport({
    ...
    final _path = r'/api/documents/{document_id}/cancel'.replaceAll(
        '{' r'document_id' '}',
  ...
  Future<Response<DocumentImportResponse>> completeDocumentImport({
    ...
    final _path = r'/api/documents/{document_id}/complete'.replaceAll(
        '{' r'document_id' '}',
        encodeQueryParameter(_serializers, documentId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(CompleteDocumentImportRequest);
      _bodyData = _serializers.serialize(completeDocumentImportRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<DocumentImportResponse>> createDocumentImport({
    ...
    try {
      const _type = FullType(DocumentImportRequest);
      _bodyData =
          _serializers.serialize(documentImportRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<DocumentUploadSessionResponse>> createDocumentUploadSession({
    ...
    final _path = r'/api/documents/{document_id}/upload-sessions'.replaceAll(
        '{' r'document_id' '}',
        encodeQueryParameter(_serializers, documentId, const FullType(String))
            .toString());
    final _options = Options(
