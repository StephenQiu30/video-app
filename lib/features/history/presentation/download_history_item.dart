...
import 'package:framegrab/features/history/presentation/download_delete_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: AuthenticatedMediaCover(
                            alt:
                                '${item.title} ${localizations.mediaCoverLabel}',
        ...
        DownloadDeleteButton(jobId: item.id, status: item.status.name),
      ],
    );
  }
}
