...
认证、登录后只读数据、来源发现、媒体检查、创建下载、视频与剧本文档上传和删除、详情封面、短期文件授权、取消/重试、视频与剧本文档 AI 分析和移动管理中心已经解除阻塞；资料修改、配置完整管理及 DOCX 原生二进制导出也已冻结；WebSocket Token 更新仍须单独冻结后才能接入。对应未冻结操作继续 fail closed，不显示模拟远程结果。
