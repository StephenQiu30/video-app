...
2026-09-08 业务评审修复已同步至 [006 会话验收](acceptance/006-原生认证与应用导航验收.md)、[014 分析验收](acceptance/014-视频AI智能分析入口验收.md) 和 [016 上传验收](acceptance/016-原生文件上传与媒体组件体验验收.md)：全量 173 项测试、双端构建及 iOS 模拟器真实集成 3 项通过，真机与 ToC 发布门槛仍按各验收边界执行。
...
| 015 | 公开首页与持久主题 | [Accepted](design/015-公开首页与持久主题设计.md) | [Accepted](prd/015-公开首页与持久主题需求.md) | [Complete](plans/015-公开首页与持久主题计划.md) | [Passed](acceptance/015-公开首页与持久主题验收.md) |
| 016 | 原生文件上传与媒体组件体验 | [Accepted](design/016-原生文件上传与媒体组件体验设计.md) | [Accepted](prd/016-原生文件上传与媒体组件体验需求.md) | [Complete](plans/016-原生文件上传与媒体组件体验计划.md) | [Passed](acceptance/016-原生文件上传与媒体组件体验验收.md) |
| 017 | 用户内容删除与 Web 文案同步 | [Accepted](design/017-用户内容删除与Web文案同步设计.md) | [Accepted](prd/017-用户内容删除与Web文案同步需求.md) | [Complete](plans/017-用户内容删除与Web文案同步计划.md) | [Passed](acceptance/017-用户内容删除与Web文案同步验收.md) |
| 018 | Markdown 报告预览 | [Accepted](design/018-Markdown报告预览设计.md) | [Accepted](prd/018-Markdown报告预览需求.md) | [Complete](plans/018-Markdown报告预览计划.md) | [Passed](acceptance/018-Markdown报告预览验收.md) |
| 019 | 剧本文档详情与跨端一致性 | [Accepted](design/019-剧本文档详情与跨端一致性设计.md) | [Accepted](prd/019-剧本文档详情与跨端一致性需求.md) | [Complete](plans/019-剧本文档详情与跨端一致性计划.md) | [Passed（真机安装待设备在线）](acceptance/019-剧本文档详情与跨端一致性验收.md) |
...
当前页面信息架构以 `video-server` 的普通用户能力为基线：匿名根路由先展示开源、自托管项目介绍；登录后首页承载链接、本地视频与剧本文档入口，一级导航包含首页、下载记录、剧本文档、平台状态与我的。原生认证、下载历史与详情、本地 MP4/剧本文档上传、用户下载和剧本文档删除、剧本文档列表与详情、规范化正文预览、剧本分析与改写、平台状态、私有封面、短时播放/下载地址和按角色开放的移动管理中心均已接入真实服务；浅色/深色主题在公开、认证与业务页面一键切换并持久化，状态数据在登录后预取并按会话缓存。接口边界见 [`contracts/README.md`](contracts/README.md)。

2026-09-08 全业务一致性已通过本次验收（182 项测试、3 项 iOS 集成、双端构建）：[020 设计](design/020-App与Web全业务一致性设计.md) · [需求](prd/020-App与Web全业务一致性需求.md) · [计划](plans/020-App与Web全业务一致性计划.md) · [验收](acceptance/020-App与Web全业务一致性验收.md)。

2026-09-21 发现服务端共享业务接口已统一为 `{code, message, data}`，而 App 冻结客户端仍按直接业务模型解析；修复与 App/Web 现场对比见 [023 设计](design/023-App与Web响应契约和服务一致性设计.md) · [需求](prd/023-App与Web响应契约和服务一致性需求.md) · [计划](plans/023-App与Web响应契约和服务一致性计划.md) · [验收](acceptance/023-App与Web响应契约和服务一致性验收.md)。
