...
- Vercel 参考：[`docs/images/visual-qa/vercel-home-reference.png`](docs/images/visual-qa/vercel-home-reference.png)。
- 方案 3 真值：[`docs/images/visual-qa/design-direction.png`](docs/images/visual-qa/design-direction.png)。
- 最终桌面实现：[`docs/images/visual-qa/implementation-desktop.png`](docs/images/visual-qa/implementation-desktop.png)。
- 最终移动实现：[`docs/images/visual-qa/implementation-mobile.png`](docs/images/visual-qa/implementation-mobile.png)。
- 同一比较输入：[`docs/images/visual-qa/comparison.png`](docs/images/visual-qa/comparison.png)，左侧为方案 3，右侧为最终实现。
